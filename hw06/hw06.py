...
class VendingMachine:
    ...
    def __init__(self, candy, price):
        self.price = price
        self.candy = candy
        # self.product = {self.candy : 0}
        self.number = 0
        self.money = 0
    
    def restock(self, number):
        self.number += number
        # self.product[self.candy] += 1
        return f'Current {self.candy} stock: {self.number}'
    ...
    def vend(self):
        if self.number == 0:
            ...
            return f'Here is your {self.candy}.'
        elif self.money > self.price:
            money = self.money
            price = self.price
            self.money = 0
            self.number -= money // price
            return f'Here is your {self.candy} and ${money - price} change.'
