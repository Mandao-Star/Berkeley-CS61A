...
class Frame:
    ...
    def make_child_frame(self, formals, vals):
        ...
        # scheme_to_py_list = lambda x: [x.first] + scheme_to_py_list(x.rest) if x != nil else []
        # formal = scheme_to_py_list(formals)
        # val = scheme_to_py_list(vals)

        # for symbol, value in zip(formal, val):
